...
```{r}
library(readr)
rennes2021 <- read_csv("rennes2021.csv", col_types = cols(valeur_fonciere = col_number()))

cesson2021 <- read_csv("cesson2021.csv",     col_types = cols(valeur_fonciere = col_number()))
saintjacques2021 <- read_csv("saintjacques2021.csv", 
     col_types = cols(valeur_fonciere = col_number()))

rennes2023 <- read_csv("rennes2023.csv", 
    col_types = cols(valeur_fonciere = col_number()))
cesson2023 <- read_csv("cesson2023.csv", 
   col_types = cols(valeur_fonciere = col_number()))
saintjacques2023 <- read_csv("saintjacques2023.csv", 
   col_types = cols(valeur_fonciere = col_number()))
```
...
ggplot() +
  ...
  geom_point(data = transactions, aes(x = Longitude, y = Latitude), color = "red", size = 2, alpha = 0.7) +
